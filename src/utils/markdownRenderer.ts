...
class MarkdownRenderer {
    ...
    private async renderMermaidDiagram(container: HTMLElement): Promise<void> {
        try {
            ...
            const errorContainer = renderContainer?.querySelector('.mermaid-error-container') as HTMLElement;
            
            if (!codeWrapper || !renderContainer || !mermaidElem || !loadingElem || !errorContainer) {
